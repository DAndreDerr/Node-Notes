...
const port = 4000; // port where the server will be hoste
...
const server = http.createServer((req,res) => {
    if(req.url === "/"){
        ...
        res.writeHead(200, {"Content-Type": "text/html"}); //with writeHead we are allowing JavaScript to grab our content with html
    ...
    } // here we are required to use our "/" and our url in order to see our second cat
